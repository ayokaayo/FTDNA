...
| List + Tabs | `LIST-TAB` | 3 | 0 | No | No |
| List + Tabs + Toolbar | `LIST-FULL` | 2 | 0 | No | No |
| Settings Form | `FORM` | ~4 | 2 | No | Partial |
...
| 4 | Lifecycle Automation | LIST-TAB | T2 | Not started | — | — | Tabs + table |
| 5 | All Activities | LIST-FULL | T2 | Not started | — | — | Full complexity list |
| 6 | Integration Settings | FORM | T3 | Not started | — | — | Multi-panel form |
...
| No-zebra table rows | Yes | Yes (Triggers) | T1 |
